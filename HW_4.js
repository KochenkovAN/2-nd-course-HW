...
while (n/2 > 50) {n = n/2; i++}
console.log('Получилось число ' + n + ' На операцию понадобилось ' + i + ' цикла(ов).');

//* Задание 6 *//
// Объявляем переменную firstFraiday, которая равна первой пятнице в марте
let firstFraiday = 3;
for(i = firstFraiday; i <= 31; i = i + 7) {console.log(`Сегодня пятница ${i}-е число. Необходимо подготовить отчет.`);}
//вопрос для наставника. Как завести данные первой пятницы из внешнего интерфейса? Я попробовал через prompt, не сработало.
